...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.workersViewController = [[WorkersViewController alloc] init];
    } else {
        self.workersViewController = [[WorkersViewController alloc] init];
    }
    
    self.masterNavigationController= [[UINavigationController alloc] initWithRootViewController:self.workersViewController];
